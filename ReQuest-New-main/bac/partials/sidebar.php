  ...
  <nav class="space-y-4">
    ...
    <div x-data="{ open: false }" class="relative">
      ...
      <div x-show="open" class="mt-2 pl-6 space-y-2">
        ...
        <a href="./pmaf.php" class="block py-2 px-3 rounded hover:bg-indigo-600">PMAF</a>
        ...
        <a href="./reso.php" class="block py-2 px-3 rounded hover:bg-indigo-600">RESO</a>
        <a href="./noa.php" class="block py-2 px-3 rounded hover:bg-indigo-600">NOA</a>
  ...
  document.getElementById('logoutBtn').addEventListener('click', function() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        // Redirect to logout.php to process logout
